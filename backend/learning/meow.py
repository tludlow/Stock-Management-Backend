...
buyingCompany = "FGQR22" # buying company
sellingCompany = "ESPL27"
boughtProduct = 249 # product bought
...
y = list(zip(quantity))  # data to be predicted
...
nonUserValues = list(zip(userProduct, userStrike, userUnderlying))
userInput = list(zip(userQuantity))
