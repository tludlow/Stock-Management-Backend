...
See the data section to import the dataset to the database.
 ...
 To connect to the database you must provide your database information inside of a file named `.env` (within the root of the repository)  The contents of this file should be as follows:
 
 - DB_NAME="group23db"
 - DB_USER (user dependent)
 - DB_PASS (user dependent)
 - DB_HOST="localhost"
 - DB_PORT (probably going to be 3306)
